# Module 1 Project Part 1: remaining work

The supplied assignment is broader than the requested first-stage data proof. Its requirements are recorded here so they are not lost.

- [x] Choose the prediction-market efficiency research area.
...
The assignment prohibits predicting the stock market. This project's concept concerns information aggregation in prediction markets. The proposal and final scope still need to be aligned with the instructor's expectations.
